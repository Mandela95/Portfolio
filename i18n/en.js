const en = {
  ...
  chat: {
    ...
    responses: {
      skills: "I'm skilled in React.js, React Native, Node.js, TypeScript, JavaScript, SQL, MongoDB, Next.js, Redux, MUI, Tailwind CSS, and more. I also have experience with Git, REST APIs, JWT Authentication, and responsive design.",
