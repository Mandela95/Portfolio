const ar = {
  ...
  beforeAfter: {
    title: "تطور المشاريع",
    subtitle: "شاهد تحول مشاريعي قبل وبعد التحسينات",
    projectName: "عرض المشروع",
    before: "قبل",
    after: "بعد",
    improvements: [
      "تحسين الأداء",
  ...
  analytics: {
    ...
    subtitle: "رؤى حول رحلتي في التطوير",
    totalProjects: "إجمالي المشاريع",
    totalProjects_value: "20+",
    totalContributions: "إجمالي المساهمات",
    totalContributions_value: "500+",
    avgProjectDuration: "متوسط مدة المشروع",
    avgProjectDuration_value: "3-4 أشهر",
  ...
  chat: {
    ...
    responses: {
      skills: "أتمتع بمهارات في React.js و React Native و Node.js و TypeScript و JavaScript و SQL و MongoDB و Next.js و Redux و MUI و Tailwind CSS وغيرها. لدي أيضًا خبرة مع Git و REST APIs و JWT Authentication و التصميم المتجاوب.",
